                    ...
                    foreach (var signal in observable.ToEnumerable())
                    {
                        ...
                        switch (signal.Type)
                        {
                            ...
                            case ProcessSignalType.OutputData:
                                data.Add(new DataLine(DataLineType.Output, signal.Data, DateTimeOffset.Now, counter));
                                counter++;
                                break;
                            case ProcessSignalType.ErrorData:
                                data.Add(new DataLine(DataLineType.Error, signal.Data, DateTimeOffset.Now, counter));
                                counter++;
                                break;
                        }
